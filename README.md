...
```jsonc
"@skene/design-system": "git+https://github.com/SkeneTechnologies/skene-design-system.git#semver:^0.14.0"
```
...
tag and pins the commit. At `^0.14.0` the range resolves `v0.14.0`, the tag the
