...
```jsonc
"@skene/design-system": "git+https://github.com/SkeneTechnologies/skene-design-system.git#semver:^0.18.0"
```
...
tag and pins the commit. At `^0.18.0` the range resolves `v0.18.0`, the tag the
...
0.17.0 and 0.18.0 the second, third and fourth: each time both the range and
