...
```jsonc
"@skene/design-system": "git+https://github.com/SkeneTechnologies/skene-design-system.git#semver:^0.26.3"
```
...
tag and pins the commit. At `^0.26.3` the range resolves `v0.26.3`, the tag the
