...
tag and pins the commit. At `^0.21.0` the range resolves `v0.21.0`, the tag the
...
0.17.0, 0.18.0, 0.19.0, 0.20.0 and 0.21.0 the second through seventh: each time both the range and
