...
```jsonc
"@skene/design-system": "git+https://github.com/SkeneTechnologies/skene-design-system.git#semver:^0.26.2"
```
...
tag and pins the commit. At `^0.26.2` the range resolves `v0.26.2`, the tag the
