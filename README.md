...
```jsonc
"@skene/design-system": "git+https://github.com/SkeneTechnologies/skene-design-system.git#semver:^0.19.0"
```
...
tag and pins the commit. At `^0.19.0` the range resolves `v0.19.0`, the tag the
...
0.17.0, 0.18.0 and 0.19.0 the second through fifth: each time both the range and
