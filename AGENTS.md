...
| # | file | answers |
|---|---|---|
| 1 | `machine/context.yaml` | **which module to reach for**, and what else each one is good for. 92 modules. Start here, always. |
...
**Grep `machine/context.yaml`.** There are 92 modules and a documented history
