...
export declare function SkeneMark({ tone, size, radius, alt, className }: SkeneMarkProps): import("react").JSX.Element;
/**
...
export declare function SkeneLockup({ tone, height, alt, className, }: SkeneLockupProps): import("react").JSX.Element;
//# sourceMappingURL=skene-mark.d.ts.map