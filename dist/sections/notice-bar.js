 ...
 */
export function NoticeBar({ role = 'note', className, children, ...props }) {
    return (_jsx("aside", { role: role, className: cn('relative z-[5] border-b border-chrome-line-subtle px-4 py-2', '[background:rgba(255,255,255,0.04)]', className), ...props, children: _jsx("div", { className: "mx-auto flex max-w-[1280px] items-center justify-center gap-1 text-center", children: children }) }));
}
