...
export function IntegrationsHighlight({ backgroundImage, actions, className, }) {
    return (_jsx("div", { className: cn('mx-auto max-w-[1350px] px-4 pb-6 md:px-6 md:pb-12', className), children: _jsx(LightSectionCard, { title: "Four ways to plug Skene in.", titleScale: "section", lede: "MCP server for your coding agent. GitHub App for every PR. Cloud API for custom runs. One-time repo audit.", actions: actions, visual: 
            ...
            // was wrong.
            _jsx("div", { className: "flex w-full min-h-[250px] items-center justify-center overflow-hidden p-6 md:min-h-0 md:p-8", children: _jsx(CardAnimationIntegrations, { backgroundImage: backgroundImage }) }), children: "Install the MCP server into Cursor or Claude Code and Skene runs before the agent commits. Install the GitHub App and it reviews every PR. Hit the cloud API directly from any script. Or run a one-time audit of your current instrumentation surface before you adopt anything else." }) }));
}
