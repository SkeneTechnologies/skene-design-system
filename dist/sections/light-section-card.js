...
export function LightSectionCard({ title, lede, children, actions, visual, reverse = false, className, }) {
    ...
    return (_jsxs("section", { className: cn(
        ...
        'light grid overflow-hidden rounded-3xl border border-chrome-line-on-light bg-brand-light', visual && (reverse ? 'md:grid-cols-[0.9fr_1.1fr]' : 'md:grid-cols-[1.1fr_0.9fr]'), className), children: [_jsxs("div", { className: cn('flex flex-col items-start px-8 pb-[46px] pt-[50px] md:px-12', reverse && visual && 'md:col-start-2 md:row-start-1'), children: [_jsx("h2", { className: "max-w-[520px] text-[clamp(2rem,3.2vw,3.25rem)] leading-[1.08] tracking-[-0.02em] text-text-primary", children: title }), lede ? (_jsx("p", { className: "mt-4 max-w-[470px] text-[15px] italic text-text-muted", children: lede })) : null, hasProof ? (_jsxs("div", { className: "mt-7 w-full border-t pt-7", style: { borderTopColor: 'var(--color-chrome-line-on-light)' }, children: [children ? (
