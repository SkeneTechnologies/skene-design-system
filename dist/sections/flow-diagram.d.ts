...
export declare function FlowDiagram({ children, note, className }: FlowDiagramProps): import("react").JSX.Element;
 ...
 */
export declare function FlowNode({ label, detail, className }: FlowNodeProps): import("react").JSX.Element;
 ...
 */
export declare function FlowEdge({ value, meta, className }: FlowEdgeProps): import("react").JSX.Element;
