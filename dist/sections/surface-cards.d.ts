...
export declare function SurfaceCards({ surfaces, featured, texture, className }: SurfaceCardsProps): import("react").JSX.Element;
//# sourceMappingURL=surface-cards.d.ts.map