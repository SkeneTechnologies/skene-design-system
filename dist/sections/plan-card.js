...
export function PlanCard({ tier, tierAs, flag, price, unit, summary, features, bestFor, action, footnote, featured = false, className, }) {
    return (_jsxs("div", { className: cn('flex min-h-[420px] flex-col rounded-2xl border p-7', featured
            ...
            : 'border-chrome-line-subtle bg-chrome-surface-1 text-text-primary', className), style: featured ? { boxShadow: 'var(--shadow-modal)' } : undefined, children: [_jsxs("div", { className: "flex min-h-[28px] items-center justify-between gap-3", children: [(() => {
                    ...
                    })(), flag ? (_jsx("span", { className: "font-mono text-[11px] uppercase tracking-[0.05em] text-brand-peach", children: flag })) : null] }), _jsxs("div", { className: "mb-[18px] mt-7 flex items-baseline gap-1.5", children: [_jsx("strong", { className: "text-[clamp(2.55rem,4vw,4rem)] font-normal leading-none tracking-[-0.06em]", children: price }), unit ? _jsx("span", { className: "text-text-muted", children: unit }) : null] }), summary ? (_jsx("p", { className: "mb-7 text-[14px] text-text-muted", children: summary })) : null, features, bestFor ? (_jsxs("div", { className: "mb-6 mt-auto grid gap-[3px] border-t pt-5", style: {
