 ...
 */
export declare function MetaPill({ children }: {
 ...
 */
export declare function VerifyRow({ name, note, tags, status, verdict, field, }: VerifyRequirement & {
    field?: boolean;
}): import("react").JSX.Element;
...
export declare function EvaluatorVerify({ crumb, summary, title, subtitle, requirements, note, frame, className, }: EvaluatorVerifyProps): import("react").JSX.Element;
//# sourceMappingURL=evaluator-verify.d.ts.map