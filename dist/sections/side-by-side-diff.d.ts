 ...
 */
export declare function DiffLine({ kind, addedLabel, removedLabel, children, className, }: DiffLineProps): import("react").JSX.Element;
 ...
 * it.
 */
export declare function DiffColumn({ side, label, lines, addedLabel, removedLabel, className, }: DiffColumnProps): import("react").JSX.Element;
 ...
 * the ink is not.
 */
export declare function SideBySideDiff({ children, className }: SideBySideDiffProps): import("react").JSX.Element;
//# sourceMappingURL=side-by-side-diff.d.ts.map